...
function Multiply(){
    var firstNumberMultiply = document.getElementById('firstNumberMultiply').value;
    var secondNumberMultiply = document.getElementById('secondNumberMultiply').value;
    ...
    if(firstNumberMultiply + secondNumberMultiply == ""){
        ...
        console.log('M else');
        ons.notification.toast("Your Number is " + (firstNumberMultiplyInteger * secondNumberMultiplyInteger), {timeout:2000});
